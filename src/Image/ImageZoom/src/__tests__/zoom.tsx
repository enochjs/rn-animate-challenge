...
export function Zoom(props: Props) {
  ...
  // is end
  const isPanEndOne = useSharedValue(true);
  //
  ...
  const gesture = useMemo(() => {
      ...
      .onUpdate((e) => {
        ...
        if (e.numberOfPointers === 1 && isPinching.value) {
          ...
          if (isPinching.value) {
            ...
            translationX.value =
              prevTranslationX.value + -1 * ((scale.value - offsetScale.value) * (originX.value - viewWidth.value / 2));
            translationY.value =
    ...
    const doubleTap = Gesture.Tap()
      .onStart((e) => {
        console.log('====come in double tap');
    ...
    return Gesture.Race(
      doubleTap,
      simultaneousGesture ? Gesture.Simultaneous(pan, pinch, simultaneousGesture) : Gesture.Simultaneous(pan, pinch)
    );
