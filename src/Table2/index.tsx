...
export default function Table() {
  ...
  const handleScrollVertical = useCallback((event: NativeSyntheticEvent<NativeScrollEvent>) => {
  ...
  return (
    <SafeAreaView>
      <View className=" relative" style={{ position: 'relative', height: 300, overflow: 'hidden' }}>
